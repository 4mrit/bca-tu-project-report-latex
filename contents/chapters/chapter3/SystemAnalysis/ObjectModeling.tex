...
Object modeling is essential to understand the static structure of the system and the interaction between different entities. In this project, the system is designed to allow small shop owners to manage their products, orders, and customers efficiently. Object modeling is represented through class diagrams and object diagrams.

\textbf{Class Diagram:} The class diagram below represents the main classes, their attributes, methods, and relationships within the system.
...
\begin{figure}[H]
    ...
    \caption{Object Diagram Showing Customer Placing an Order}
\end{figure}
